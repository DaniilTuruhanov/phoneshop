...
@Component
public class FromOrderToAdminDetailsDataPopulator implements Populator<OrderModel, AdminDetailsData> {

    @Override
    public void populate(OrderModel order, AdminDetailsData adminOrderData) {
